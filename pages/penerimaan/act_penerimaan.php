<?php
	...
	if($mod == "penerimaan" AND $act == "simpan")
	{
		//variable input
		...
		mysqli_query($conn, "INSERT INTO penerimaan(
	...
	elseif ($mod == "penerimaan" AND $act == "edit") 
	{
		//variable input
		...
		mysqli_query($conn, "UPDATE penerimaan SET 
	...
	elseif ($mod == "penerimaan" AND $act == "hapus") 
	{
		mysqli_query($conn, "DELETE FROM penerimaan WHERE idPemesanan = '$_GET[id]'");
		echo"<script>
			window.history.back();
		</script>";	
	}
