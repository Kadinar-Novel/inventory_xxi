<?php
    ...
    switch ($method) {
        case 'GET':
          $sql = "SELECT * FROM penerimaan ".($key ?" WHERE idPemesanan =$key":''); 
        break;
        case 'PUT': $sql = "UPDATE penerimaan SET 
        ...
        break;
        case 'POST': $sql = "INSERT INTO penerimaan( 
        ...
        break;
        case 'DELETE':
           $sql = "DELETE FROM penerimaan WHERE idPemesanan = $key"; 
        break;
    }       
